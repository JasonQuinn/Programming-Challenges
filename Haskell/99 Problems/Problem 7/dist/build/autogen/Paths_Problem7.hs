...
getLibDir = getPrefixDirRel "Problem7-0.0.1\\ghc-7.0.4"

getDataDir :: IO FilePath
getDataDir =  catch (getEnv "Problem7_datadir") (\_ -> getPrefixDirRel "Problem7-0.0.1")

getLibexecDir :: IO FilePath
getLibexecDir = getPrefixDirRel "Problem7-0.0.1"
